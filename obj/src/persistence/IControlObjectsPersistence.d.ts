...
export interface IControlObjectsPersistence extends IGetter<ControlObjectV1, string>, IWriter<ControlObjectV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: ControlObjectV1) => void): void;
    create(correlationId: string, item: ControlObjectV1, callback: (err: any, item: ControlObjectV1) => void): void;
    update(correlationId: string, item: ControlObjectV1, callback: (err: any, item: ControlObjectV1) => void): void;
    unsetObject(correlationId: string, orgId: string, objectId: string, callback: (err: any) => void): void;
    deleteById(correlationId: string, id: string, callback: (err: any, item: ControlObjectV1) => void): void;
}
